        ...
        <Container maxWidth="xl" sx={{ py: 8 }}>
            ...
            <Box sx={{
                ...
                <Box sx={{ flex: '1 1 40%', width: '100%' }}>
                    <Typography variant="h2" component="h1" gutterBottom sx={{ fontWeight: 'bold', display: 'flex', alignItems: 'center', fontSize: { xs: '1.2rem', md: '2rem' } }}>
                        <Box component="span" sx={{ display: 'inline-flex', marginLeft: '-10px', marginRight: '3px', position: 'relative', top: '0px', width: { xs: 45, md: 60 }, height: { xs: 45, md: 60 } }}>
