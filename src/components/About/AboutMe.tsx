                ...
                <Box sx={{ my: 4 }}>
                    ...
                    <Grid container spacing={4}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            <Typography variant="body1">
                                느낌: 어떠한 것을 바라본 시선, 이로 인한 감정, 그것으로 부터 시작 된 생각.
                            </Typography>
                            <Typography variant="body1">
                                같은 공간에서도 서로가 조금씩은 다를 수 밖에 없는, 내면의 주관적이고 관념적인 것.
                            </Typography>
                        </Grid>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="body1">
                    ...
                    <Grid container spacing={4}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="body1" sx={{ mb: 3 }}>
                                회복과 치유는 계속적으로 내가 해 온 - 이어갈 이야기이다. 예술은 많은 이들에게 다양한 의미를 갖는다. 나에게 있어서 예술은 감정을 움직여주며 누군가를 포용하는 것이면 좋겠다. 내면의 아이와 과거의 경험을 통한 현재의 느낌을 그려내 새로운 공간이 된다. 어쩌면 작업의 동기를 가지고 작업을 진행해 나간다는 것 자체가 의미 있는 예술활동이다. 주사기라는 설치 작업을 했었을 땐, 이전에 나를 아프게 했던 주사기였지만 이제는 작품을 만들기 위한 하나의 오브제로 변경시키고 그것이 새로운 의미를 갖게 한다고 했었다. 작업으로 가져온 이유는 조금 다를 지라도 마치 요셉코수스가 자신의 기억에 있는 펠트를 가지고 설치 작업을 했던 것처럼 그 물질을 작업으로 가져옴으로써 회복의 의미를 부여하려했던 것이다.
                            </Typography>
                            <Typography variant="body1">
                    ...
                    <Grid container spacing={4}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="body1">
                                그 다음에는 치유와 회복의 이미지들을 담기 시작했다. 아이스크림- 우는 아이들에게 아이스크림 같은 달콤한 간식을 건넸을때 기분이 나아지고 울음을 그치는 그런 달콤하고 다정한 것들. 그래서 도넛박스에, 커피 투고 캐리어에, 휘핑크림위에 담고 놓아 순간의 쉼이 될 수 있길, 저기압된 기분이 한층 밝아질 수 있길 바랐다. 손에서 손으로 전달할 수 있는 것들을 그려 - 마음을 전하고, 위로를 건네려 하는 손길같은. ♥
                            </Typography>
                        </Grid>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="body1">
                    ...
                    <Grid container spacing={4}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="body1" sx={{ mb: 1 }}>
                                나를 아는 사람들은 그림이 꼭 너 같다고 한다. 내가 그려내는 그림들과 캐릭터들이 나같다는 말을 듣는건 진실된이야기가 통한 것 같아 기분이 좋다. 인위적이지 않고 가식적이지 않는 그런삶이 자연스러운 것처럼 나를 있는 그대로 담아낸 그림.
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 1 }}>
                                병실의 공간을 재해석해서 그린 그림을 나중에야 본 엄마는 한편으로는 마음 아파했다. 엄마가 되어보니 그때 들은 말의 마음이 이해가 돼 되려 미안했다. 내용을 들여다보기전 처음 그림을 본 사람들은 밝은색감에 - 밝고 화사한 느낌을 받는다. 호텔인가? 라는 생각, 같이 놀러온 방인가? 라는 느낌. 그게 재밌어서 먼저 물어보기를 자처했다. 이거 뭐같아? 뭐 그린 것 같아?
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 1 }}>
                                생각해보면 숨지 않았던 것 같다. 그리고 아팠다고 해서 힘들다고 해서 그만하고 싶었던 것도 아니었다.
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 1 }}>
                                나를 드러냈다기보단 내가 녹아 스며든 작업, 그린 -그림, 그려진 - 그림들.
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 1 }}>
                                그림 앞에서 공간을 느끼고 그림에 담은 분위기를 전달 받는 것 -
                            </Typography>
                            <Typography variant="body1" sx={{ mb: 1 }}>
                                이것은 색감을 물성화한 회화작업이 가질 수 있는 고유한 회화성
                            </Typography>
                            <Typography variant="body1">
                                그리고 그 그림 안으로 들어가 머물러 있을 수 있게하는 끌림이다.
                            </Typography>
                        </Grid>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Typography variant="body1" sx={{ mb: 1 }}>
